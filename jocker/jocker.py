...
DEFAULT_CONFIG_FILE = "~/.jocker/config.yml"
...
def run(varsfile=DEFAULT_VARSFILE, templatefile=DEFAULT_DOCKERFILE,
        ...
        dryrun=False, configfile=DEFAULT_CONFIG_FILE, verbose=False):
    ...
    docker_config = import_config(configfile)
    client_config = docker_config.get('client', DEFAULT_CLIENT_CONFIG)
    build_config = docker_config.get('build', DEFAULT_BUILD_CONFIG)
